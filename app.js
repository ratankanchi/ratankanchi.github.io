...
document.getElementById("linkedin_icon").addEventListener("click", () => {
  location.href = "https://www.linkedin.com/in/ratan-kanchi-113aa6159";
});

$(document).ready(function () {
  $("#menu_buttons a").on("click", () => {
    document.getElementById("side-menu-id").classList.toggle("change2");
    p = document.getElementById("responsive_nav");
    q = document.querySelector(".side-text");
